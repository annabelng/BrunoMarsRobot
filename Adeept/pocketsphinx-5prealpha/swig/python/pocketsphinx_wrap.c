...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Segment_ascore_set", _wrap_Segment_ascore_set, METH_VARARGS, (char *)"Segment_ascore_set(Segment self, int32 ascore)"},
	 { "Segment_ascore_get", _wrap_Segment_ascore_get, METH_VARARGS, (char *)"Segment_ascore_get(Segment self) -> int32"},
	 { "Segment_lscore_set", _wrap_Segment_lscore_set, METH_VARARGS, (char *)"Segment_lscore_set(Segment self, int32 lscore)"},
	 { "Segment_lscore_get", _wrap_Segment_lscore_get, METH_VARARGS, (char *)"Segment_lscore_get(Segment self) -> int32"},
	 { "Segment_lback_set", _wrap_Segment_lback_set, METH_VARARGS, (char *)"Segment_lback_set(Segment self, int32 lback)"},
	 { "Segment_lback_get", _wrap_Segment_lback_get, METH_VARARGS, (char *)"Segment_lback_get(Segment self) -> int32"},
	 { "Segment_prob_set", _wrap_Segment_prob_set, METH_VARARGS, (char *)"Segment_prob_set(Segment self, int32 prob)"},
	 { "Segment_prob_get", _wrap_Segment_prob_get, METH_VARARGS, (char *)"Segment_prob_get(Segment self) -> int32"},
	 ...
	 { "Segment_fromIter", _wrap_Segment_fromIter, METH_VARARGS, (char *)"Segment_fromIter(ps_seg_t * itor) -> Segment"},
	 ...
	 { "NBest_score_set", _wrap_NBest_score_set, METH_VARARGS, (char *)"NBest_score_set(NBest self, int32 score)"},
	 { "NBest_score_get", _wrap_NBest_score_get, METH_VARARGS, (char *)"NBest_score_get(NBest self) -> int32"},
	 { "NBest_fromIter", _wrap_NBest_fromIter, METH_VARARGS, (char *)"NBest_fromIter(ps_nbest_t * itor) -> NBest"},
	 ...
	 { "SegmentIterator_ptr_set", _wrap_SegmentIterator_ptr_set, METH_VARARGS, (char *)"SegmentIterator_ptr_set(SegmentIterator self, ps_seg_t * ptr)"},
	 { "SegmentIterator_ptr_get", _wrap_SegmentIterator_ptr_get, METH_VARARGS, (char *)"SegmentIterator_ptr_get(SegmentIterator self) -> ps_seg_t *"},
	 { "new_SegmentIterator", _wrap_new_SegmentIterator, METH_VARARGS, (char *)"new_SegmentIterator(ps_seg_t * ptr) -> SegmentIterator"},
	 ...
	 { "NBestIterator_ptr_set", _wrap_NBestIterator_ptr_set, METH_VARARGS, (char *)"NBestIterator_ptr_set(NBestIterator self, ps_nbest_t * ptr)"},
	 { "NBestIterator_ptr_get", _wrap_NBestIterator_ptr_get, METH_VARARGS, (char *)"NBestIterator_ptr_get(NBestIterator self) -> ps_nbest_t *"},
	 { "new_NBestIterator", _wrap_new_NBestIterator, METH_VARARGS, (char *)"new_NBestIterator(ps_nbest_t * ptr) -> NBestIterator"},
	 ...
	 { "Decoder_set_allphone_file", _wrap_Decoder_set_allphone_file, METH_VARARGS, (char *)"Decoder_set_allphone_file(Decoder self, char const * name, char const * lmfile)"},
	 { "Decoder_get_lm", _wrap_Decoder_get_lm, METH_VARARGS, (char *)"Decoder_get_lm(Decoder self, char const * name) -> NGramModel"},
	 { "Decoder_set_lm", _wrap_Decoder_set_lm, METH_VARARGS, (char *)"Decoder_set_lm(Decoder self, char const * name, NGramModel lm)"},
	 { "Decoder_set_lm_file", _wrap_Decoder_set_lm_file, METH_VARARGS, (char *)"Decoder_set_lm_file(Decoder self, char const * name, char const * path)"},
